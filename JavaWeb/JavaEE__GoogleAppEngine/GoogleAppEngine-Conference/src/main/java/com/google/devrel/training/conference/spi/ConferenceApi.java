 ...
 */
@Api(
        name = "conference", version = "v1", scopes = {Constants.EMAIL_SCOPE},
...
public class ConferenceApi {
    ...
    public Profile saveProfile(final User user, ProfileForm profileForm) throws UnauthorizedException {
        ...
        if (profile == null) {
            ...
            profile = profile.update(displayName, teeShirtSize);
        }
    ...
    public Conference createConference(final User user, final ConferenceForm conferenceForm) throws UnauthorizedException {
        ...
        Key<Profile> profileKey = OfyService.factory().allocateId(Profile.class);
        ...
        queue.add(TaskOptions.Builder
                .withUrl("/send_email")
                .param("email", "dorogan.olga.n@gmail.com")
    ...
    public List<Conference> getConferencesCreated(final User user) throws UnauthorizedException {
        ...
        return ofy().load().type(Conference.class).ancestor(Key.create(Profile.class, profile.getUserId())).order("name").list();
    }
    ...
    public Collection<Conference> getConferencesToAttend(final User user)
        ...
        Collection<Key<Conference>> conferenceKeys = new ArrayList<>(0);
        for (String keyStringToAttend : keyStringsToAttend) {
            conferenceKeys.add(Key.create(Conference.class, keyStringToAttend));
        }
    ...
    public Announcement getAnnouncement() {
        ...
        String announcementMessage = (String) memcacheService.get(Constants.MEMCACHE_ANNOUNCEMENTS_KEY);
        Announcement announcement = new Announcement();
        announcement.setMessage(announcementMessage);
        return announcement;
    }
